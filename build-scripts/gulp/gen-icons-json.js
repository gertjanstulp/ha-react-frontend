...
const HASS_PATH = path.resolve("homeassistant-frontend")
const META_PATH = path.resolve(ICON_PACKAGE_PATH, "meta.json");
const PACKAGE_PATH = path.resolve(ICON_PACKAGE_PATH, "package.json");
const ICON_PATH = path.resolve(ICON_PACKAGE_PATH, "svg");
const OUTPUT_DIR = path.resolve(__dirname, HASS_PATH, "build/mdi");
const REMOVED_ICONS_PATH = path.resolve(__dirname, HASS_PATH, "build-scripts/removedIcons.json");
