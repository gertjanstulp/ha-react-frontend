...
import { throttle } from "../../homeassistant-frontend/src/common/util/throttle";
import { HistoryResult } from "../../homeassistant-frontend/src/data/history";
import { HomeAssistant } from "../../homeassistant-frontend/src/types";
import { getRecentWithCache } from "../../homeassistant-frontend/src/data/cached-history";

// import "../../homeassistant-frontend/src/components/chart/state-history-charts"
...
@customElement("react-more-info-history")
export class ReactMoreInfoHistory extends LitElement {
    ...
    protected updated(changedProps: PropertyValues): void {
        ...
        //     this._showMoreHref = `/history?entity_id=${this.entityId}&start_date=${startOfYesterday().toISOString()}`;
...
declare global {
    interface HTMLElementTagNameMap {
        "react-more-info-history": ReactMoreInfoHistory;
    }
}
